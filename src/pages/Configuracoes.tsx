...
export default function Configuracoes() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Configurações"
        description="Personalize as configurações da sua ótica"
      />

      <Tabs defaultValue="store" className="space-y-6">
        <TabsList className="bg-card border border-border p-1 h-auto flex-wrap">
          <TabsTrigger value="store" className="gap-2 data-[state=active]:gradient-primary data-[state=active]:text-primary-foreground">
            <Store className="w-4 h-4" />
            <span className="hidden sm:inline">Informações da Loja</span>
            <span className="sm:hidden">Loja</span>
          </TabsTrigger>
          <TabsTrigger value="sales" className="gap-2 data-[state=active]:gradient-primary data-[state=active]:text-primary-foreground">
          ...
          <TabsTrigger value="appearance" className="gap-2 data-[state=active]:gradient-primary data-[state=active]:text-primary-foreground">
        ...
        <TabsContent value="store" className="space-y-6 animate-fade-in">
          <div className="bg-card rounded-xl border border-border p-6">
            ...
            <Button className="mt-6 gradient-primary text-primary-foreground hover:opacity-90">
